    ...
    <div className="p-6 md:p-8 space-y-8">
      ...
      <SectionCard>
        <CardHeader>
          ...
          <span className="text-[9px] md:text-[11px] font-mono font-semibold text-[#8b949e] uppercase tracking-widest">
            Who's Been Here - Visitors Log
          </span>
          <span className="ml-auto text-[9px] md:text-[10px] font-mono text-[#8b949e]">
